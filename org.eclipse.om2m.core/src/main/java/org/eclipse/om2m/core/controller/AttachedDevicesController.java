 ...
 * generic REST request for {@link AttachedDevices} collection resource.
 *
 * @author <ul>
...
public class AttachedDevicesController extends Controller {

    /**
     * Creates {@link AttachedDevices} resource.
     * @param requestIndication - The generic request to handle.
     * @return The generic returned response.
     */
    public ResponseConfirm doCreate (RequestIndication requestIndication) {

        // attachedDeviceCollection:    (createReq NA) (response M)
    ...
    /**
     * Retrieves {@link AttachedDevices} resource.
     * @param requestIndication - The generic request to handle.
     * @return The generic returned response.
     */
    public ResponseConfirm doRetrieve (RequestIndication requestIndication) {

        // attachedDevicesCollection:   (response M)
        ...
        AttachedDevices attachedDevices = DAOFactory.getAttachedDevicesDAO().find(requestIndication.getTargetID());
        ...
        // Check AccessRight
        errorResponse = checkAccessRight(attachedDevices.getAccessRightID(), requestIndication.getRequestingEntity(), Constants.AR_READ);
        if (errorResponse != null) {
            return errorResponse;
        }
        // Response
        return new ResponseConfirm(StatusCode.STATUS_OK, attachedDevices);
    }

    /**
     * Updates {@link AttachedDevices} resource.
     * @param requestIndication - The generic request to handle.
     * @return The generic returned response.
     */
    public ResponseConfirm doUpdate (RequestIndication requestIndication) {

        // attachedDevicesCollection:   (updateReq NP) (response M)
        ...
        ResponseConfirm errorResponse = new ResponseConfirm();
        AttachedDevices attachedDevices = DAOFactory.getAttachedDevicesDAO().lazyFind(requestIndication.getTargetID());
        ...
        // Check AccessRight
        errorResponse = checkAccessRight(attachedDevices.getAccessRightID(), requestIndication.getRequestingEntity(), Constants.AR_WRITE);
        if (errorResponse != null) {
            return errorResponse;
        }
        ...
        // Check XML Validity
        errorResponse = checkMessageSyntax(requestIndication.getRepresentation(),"attachedDevices.xsd");
        if (errorResponse != null) {
            return errorResponse;
        }
        // Checks on attributes
        AttachedDevices attachedDevicesNew = (AttachedDevices) XmlMapper.getInstance().xmlToObject(requestIndication.getRepresentation());
        // attachedDeviceCollection Must be NP
        if (attachedDevicesNew.getAttachedDeviceCollection() != null) {
        ...
        if (attachedDevicesNew.getSubscriptionsReference() != null) {
        ...
        if (attachedDevicesNew.getCreationTime() != null) {
        ...
        if (attachedDevicesNew.getLastModifiedTime() != null) {
        ...
        if (DAOFactory.getAccessRightDAO().find(attachedDevicesNew.getAccessRightID()) != null) {
        ...
        // Store accessRights
        DAOFactory.getAttachedDevicesDAO().update(attachedDevices);
        // Response
        return new ResponseConfirm(StatusCode.STATUS_OK, attachedDevices);
    ...
    /**
     * Deletes {@link AttachedDevices} resource.
     * @param requestIndication - The generic request to handle.
     * @return The generic returned response.
     */
    ...
    /**
     * Executes {@link AttachedDevices} resource.
     * @param requestIndication - The generic request to handle.
     * @return The generic returned response.
     */
