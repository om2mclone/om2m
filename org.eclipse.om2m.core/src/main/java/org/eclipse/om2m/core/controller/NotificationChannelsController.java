 ...
 * generic REST request for {@link NotificationChannels} collection resource.
 *
 * @author <ul>
...
public class NotificationChannelsController extends Controller {

    /**
     * Creates {@link NotificationChannels} resource.
     * @param requestIndication - The generic request to handle.
     * @return The generic returned response.
     */
    public ResponseConfirm doCreate (RequestIndication requestIndication) {

        // notificationChannelsCollection:  (createReq NP) (response M)
    ...
    /**
     * Retrieves {@link NotificationChannels} resource.
     * @param requestIndication - The generic request to handle.
     * @return The generic returned response.
     */
    public ResponseConfirm doRetrieve (RequestIndication requestIndication) {

        // notificationChannelsCollection:  (response M)
        // creationTime:                    (response M)
        // lastModifiedTime:                (response M)

        // Response
        ResponseConfirm errorResponse = new ResponseConfirm();
        NotificationChannels notificationChannels = DAOFactory.getNotificationChannelsDAO().find(requestIndication.getTargetID());
        ...
        // Response
        return new ResponseConfirm(StatusCode.STATUS_OK, notificationChannels);
    }

    /**
     * Updates {@link NotificationChannels} resource.
     * @param requestIndication - The generic request to handle.
     * @return The generic returned response.
     */
    public ResponseConfirm doUpdate (RequestIndication requestIndication) {

        // notificationChannelsCollection:    (updateReq NP) (response M)
    ...
    /**
     * Deletes {@link NotificationChannels} resource.
     * @param requestIndication - The generic request to handle.
     * @return The generic returned response.
     */
    ...
    /**
     * Executes {@link NotificationChannels} resource.
     * @param requestIndication - The generic request to handle.
     * @return The generic returned response.
     */
